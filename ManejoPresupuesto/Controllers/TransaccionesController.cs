...
namespace ManejoPresupuesto.Controllers
{
    public class TransaccionesController: Controller
    {
        ...
        public async Task<IActionResult> Semanal(int mes, int year)
        {
            ...
            {
                var semana = i + 1;
                var fechaInicio = new DateTime(year, semana, diasSegmentados[i].First());
                var fechaFin = new DateTime(year, semana, diasSegmentados[i].Last());
        ...
        public async Task<IActionResult> Editar(int id, string urlRetorno = null)
        {
            ...
            if (transaccion is null)
            {
                return RedirectToAction("NoEntontrado", "Home");
            }
